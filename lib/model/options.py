...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_ours.add_argument('--meshDirSearch', type=str, default="/media/amax/4C76448F76447C28/Dataset/COMA_fill")
        g_ours.add_argument('--trainingDataRatio', type=float, default="0.1")  # gai cheng 0.998 de traindataset;
        g_ours.add_argument('--datasetDir', type=str, default=r"/media/lx/Data3/FullData/Render")  # this is home of meshdata
        ...
        g_ours.add_argument('--resume_name', type=str, default='Train_normal', help='name of the experiment. It decides where to load weights to resume training')
        ...
        g_exp.add_argument('--name', type=str, default='Train_Normal',
        ...
        g_train.add_argument('--gpu_ids', type=str, default='1', help='gpu ids: e.g. 0  0,1,2, 0,2, -1 for CPU mode')

        g_train.add_argument('--num_threads', default=8, type=int, help='# sthreads for loading data')
        g_train.add_argument('--serial_batches', action='store_true',  # false
                             help='if true, takes images in order to make batches, otherwise takes them randomly')
        g_train.add_argument('--pin_memory', action='store_true', help='pin_memory')  # false
        ...
        g_train.add_argument('--num_epoch', type=int, default=12, help='num epoch to train')

        g_train.add_argument('--freq_plot', type=int, default=1000, help='freqency of the error plot')
        ...
        g_sample.add_argument('--num_sample_inout', type=int, default=20000, help='# of sampling points')
        ...
        # path
        parser.add_argument('--checkpoints_path', type=str, default=r'/home/lx/doucument/python_code/train_Normal/checkpoints', help='path to save checkpoints')
